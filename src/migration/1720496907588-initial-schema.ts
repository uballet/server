...
export class InitialSchema1720496907588 implements MigrationInterface {
    name = 'InitialSchema1720496907588'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "stamper" ("id" character varying NOT NULL, "userId" uuid NOT NULL, "expiresAt" TIMESTAMP NOT NULL, CONSTRAINT "PK_3530404c5ef3fc4f84f60c8a78b" PRIMARY KEY ("id"))`);
